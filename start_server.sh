...
# 启动 gunicorn 服务器
../venv/bin/gunicorn --worker-class=gthread --log-level debug -w 1 --threads 10 --timeout 120 -b 0.0.0.0:9899 runserver:app -D --access-logfile /root/apps/chatgpt-wecom/logs/access.log --error-logfile /root/apps/chatgpt-wecom/logs/error.log
